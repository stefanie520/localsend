...
class DiscoveryMethodMapper extends ClassMapperBase<DiscoveryMethod> {
  ...
  static DiscoveryMethodMapper ensureInitialized() {
    if (_instance == null) {
      ...
      UsbDiscoveryMapper.ensureInitialized();
    }
    return _instance!;
  }
...
class UsbDiscoveryMapper extends ClassMapperBase<UsbDiscovery> {
  UsbDiscoveryMapper._();

  static UsbDiscoveryMapper? _instance;
  static UsbDiscoveryMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(_instance = UsbDiscoveryMapper._());
      DiscoveryMethodMapper.ensureInitialized();
    }
    return _instance!;
  }
  ...
  @override
  final String id = 'UsbDiscovery';

  @override
  final MappableFields<UsbDiscovery> fields = const {};

  static UsbDiscovery _instantiate(DecodingData data) {
    return UsbDiscovery();
  }
  ...
  static UsbDiscovery fromJson(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<UsbDiscovery>(map);
  }

  static UsbDiscovery deserialize(String json) {
    return ensureInitialized().decodeJson<UsbDiscovery>(json);
  }
}

mixin UsbDiscoveryMappable {
  String serialize() {
    return UsbDiscoveryMapper.ensureInitialized().encodeJson<UsbDiscovery>(
      this as UsbDiscovery,
    );
  }

  Map<String, dynamic> toJson() {
    return UsbDiscoveryMapper.ensureInitialized().encodeMap<UsbDiscovery>(
      this as UsbDiscovery,
    );
  }

  UsbDiscoveryCopyWith<UsbDiscovery, UsbDiscovery, UsbDiscovery> get copyWith =>
      _UsbDiscoveryCopyWithImpl<UsbDiscovery, UsbDiscovery>(
        this as UsbDiscovery,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return UsbDiscoveryMapper.ensureInitialized().stringifyValue(
      this as UsbDiscovery,
    );
  }
  ...
  @override
  bool operator ==(Object other) {
    return UsbDiscoveryMapper.ensureInitialized().equalsValue(
      this as UsbDiscovery,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return UsbDiscoveryMapper.ensureInitialized().hashValue(
      this as UsbDiscovery,
    );
  }
}

extension UsbDiscoveryValueCopy<$R, $Out>
    on ObjectCopyWith<$R, UsbDiscovery, $Out> {
  UsbDiscoveryCopyWith<$R, UsbDiscovery, $Out> get $asUsbDiscovery =>
      $base.as((v, t, t2) => _UsbDiscoveryCopyWithImpl<$R, $Out>(v, t, t2));
}

abstract class UsbDiscoveryCopyWith<$R, $In extends UsbDiscovery, $Out>
    implements DiscoveryMethodCopyWith<$R, $In, $Out> {
  @override
  $R call();
  UsbDiscoveryCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _UsbDiscoveryCopyWithImpl<$R, $Out>
    extends ClassCopyWithBase<$R, UsbDiscovery, $Out>
    implements UsbDiscoveryCopyWith<$R, UsbDiscovery, $Out> {
  _UsbDiscoveryCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<UsbDiscovery> $mapper =
      UsbDiscoveryMapper.ensureInitialized();
  @override
  $R call() => $apply(FieldCopyWithData({}));
  @override
  UsbDiscovery $make(CopyWithData data) => UsbDiscovery();

  @override
  UsbDiscoveryCopyWith<$R2, UsbDiscovery, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _UsbDiscoveryCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
